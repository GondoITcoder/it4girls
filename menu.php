    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-lg-4 text-center text-lg-left">
          <a class="text-color mr-3" href="callto:+2250768406755"><strong>APPELER</strong> +225 0768406755</a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center" style="background: #d70b52;">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="courses.html">NOS PARCOURS</a>
            </li>
            <li class="nav-item @@events">
              <a class="nav-link" href="events.html">FORUM</a>
            </li>
            <li class="nav-item @@blog">
              <a class="nav-link" href="blog.html">EVENEMENTS</a>
            </li>
